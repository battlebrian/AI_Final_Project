...
from image2text.constants import VALID_IMAGE_EXTENSIONS, WINDOWS_CHECK_COMMAND, DEFAULT_CHECK_COMMAND, TESSERACT_DATA_PATH_VAR
...
def main(input_path, output_path):
    ...
    if os.path.isdir(input_path):
        ...
        run_tesseract(filename, output_path, input_path)
